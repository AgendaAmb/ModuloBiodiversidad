<nav class="navbar navbar-expand-lg navbar-expand-xl navbar-expand-md d-flex d-lg-none d-md-none d-xl-none"  id="navP">
  ...
  <div class="collapse navbar-collapse " id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav w-100 justify-content-md-around">
      <li class="nav-item">
        <a class="nav-link" href="#">GESTION INSTITUCIONAL</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="#">EDUCACIÓN E INVESTIGACIÓN</a>
      </li>
      <li class="nav-item">
...
<nav class="navbar navbar-expand-lg navbar-expand-xl navbar-expand-md d-flex d-lg-flex d-md-flex d-xl-flex" id="navP">

  <a class="btn btn-success btn-sm MiPortal navbar-brand " href='{{route('LInstitucional')}}' role="button">
    <img src="{{asset('storage/Logos/UBICACION-1.png')}}" alt="" srcset="">
    MI PORTAL
  </a>
    ...
    <ul class="navbar-nav w-100 justify-content-md-start">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
          ...
          <li><a class="dropdown-item" href="#">EDUCACIÓN E INVESTIGACIÓN</a></li>
      ...
      <div>
        <a class="btn btn-primary btn-sm MiPortal" href='{{route('LInstitucional')}}' role="button">
          <img src="{{asset('storage/Logos/UBICACION-1.png')}}" alt="" srcset="">
          MI PORTAL
        </a>
      </div>
