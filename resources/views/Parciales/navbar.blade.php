<nav class="navbar navbar-expand-lg navbar-expand-xl navbar-expand-md " id="navP" >
    ...
    <div class="collapse navbar-collapse " id="navbarTogglerDemo03">
      <ul class="navbar-nav w-100 justify-content-md-around">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown" id="navPrincipal">
          ...
          <a class="btn btn btn-link btn-sm MiPortal text-decoration-none" href={{route('LInstitucionalP')}} role="button">
