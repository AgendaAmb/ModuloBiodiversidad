        ...
        <div class="card w-100 ">
            ...
            <div class="card-footer pl-5">
                ...
                <small class="text-muted">
                    <input type="file" accept="image/png,image/jpeg" :id="'fileImg'+index" :name="'fileImg'+index" class="inp" @change="cargarImagen($event,index)" />
                </small>
                ...
                <button class="btn btn-primary" @click="guardarFoto(index)">Guardar Foto</button>
                @endif
            </div>
        </div>
    </div>
