...
<p style="display: none;">
    <!--Variables globales para formar url de imagenes de menor calidad-->
    {{ $storage='storage/FichasTecnicas/'}}
    ...
    {{$prefijo='_F_50.jpg'}}
    {{$urlF=$storage.$InicialesEspecia.$calidad.$Clave.$prefijo}}

    <!--Variables para formar url de Hojas-->
    {{$urlH=$fichaTecnica->FichaTecnica->Url_H}}
    {{$prefijo='_H_50.jpg'}}
    {{$urlH=$storage.$InicialesEspecia.$calidad.$Clave.$prefijo}}
 <!--Variables para formar url de Flores-->
    {{$urlFL=$fichaTecnica->FichaTecnica->Url_FL}}
    {{$prefijo='_FL_50.jpg'}}
    {{$urlFL=$storage.$InicialesEspecia.$calidad.$Clave.$prefijo}}
 <!--Variables para formar url de Fruto-->
    {{$urlFR=$fichaTecnica->FichaTecnica->Url_FR}}
    {{$prefijo='_FR_50.jpg'}}
    {{$urlFR=$storage.$InicialesEspecia.$calidad.$Clave.$prefijo}}
     <!--Variables para formar url de Semillas-->
    {{$urlS=$fichaTecnica->FichaTecnica->Url_S}}
    {{$prefijo='_S_50.jpg'}}
    {{$urlS=$storage.$InicialesEspecia.$calidad.$Clave.$prefijo}}
     <!--Variables para formar url de tronco-->
    {{$urlT=$fichaTecnica->FichaTecnica->Url_T}}
    {{$prefijo='_T_50.jpg'}}
    {{$urlT=$storage.$InicialesEspecia.$calidad.$Clave.$prefijo}}

      <!--Variables para formar url de Raices-->

    {{$urlR=$fichaTecnica->FichaTecnica->Url_R}}
    {{$prefijo='_R_50.jpg'}}
    {{$urlR=$storage.$InicialesEspecia.$calidad.$Clave.$prefijo}}
            ...
            @for ($i = 2; $i < count($NombreCienti); $i++) {{$NombreCienti[$i]}} @endfor </p>
                <div class="flex-container" style="height: 441px;">
                    ...
                    <div class="container1">
                        ...
                        <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/FormasCrecimiento/Herbacea.png")}}" height="40" width="40"
                            alt="">

                        @else
                        @if ($fichaTecnica->FichaTecnica->Fcrecimiento=='Arbustiva')
                        <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/FormasCrecimiento/Arbustiva.png")}}" height="40" width="40"
                            alt="">
                        @else
                        @if ($fichaTecnica->FichaTecnica->Fcrecimiento=='Arborescente')
                        <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/FormasCrecimiento/Arborescente.png")}}" height="40" width="40"
                            alt="">
                        @else
                        @if ($fichaTecnica->FichaTecnica->Fcrecimiento=='Arbórea')
                        <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/FormasCrecimiento/Arbórea.png")}}" height="40" width="40"
                            alt="">

                        @else
                        <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/FormasCrecimiento/Columnar.png")}}" height="40" width="40"
                            alt="">
                        @endif
                        @endif
                        @endif
                        ...
                        <p class="titulos" style="margin-top: 20px;margin-bottom: 0px; padding-top: 0px;"> PERMANENCIA
                            DE
                            HOJAS</p>
                ...
                <div class="container2" style=" margin-top: 25px;">
                    ...
                    <img src="{{ public_path("$urlPC2")}}" alt=""
                        style="margin: 0%;height: 154px;width: 348px;">
                    @else

                    <img src="{{ public_path("$urlPC")}}" alt="" style="margin: 0%;height: 154px;width: 348px;">
                ...
                <div style="position: fixed;top:525;left: 287">
                    <div class="flex-container" style="height: 117px; margin: 0px; padding: 0%;">
                        <div class="item">
                            <img src="{{ public_path("$urlFR") }}" alt=""
                                style="margin: 0%;height: 110px;width: 110px;">
                            <p class="tituloImagen">FRUTO</p>
                        </div>
                        <div class="item" style="margin-left:120px;">
                            <img src="{{ public_path("$urlS") }}" alt=""
                                style="margin: 0%;height: 110px;width: 110px;">
                            <p class="tituloImagen">SEMILLAS</p>
                        </div>
                        <div class="item" style="margin-left:242px;">
                            <img src="{{ public_path("$urlR")}}" alt=""
                                style="margin: 0%;height: 110px;width: 110px;">
                ...
                <div>
                    <div class="flex-container" style="height: 470px; margin: 0px 0px 20px 0px;">
                        ...
                        <div class="item1" style="background-color: red;height: 470px;">
                            <img src="{{ public_path("$urlFL") }}" alt="..."
                                style="width: 360px;height: 470px;">
                        </div>
                        <div class="item2" style=" margin-left: 360px; padding: 20px; height: 428px;">
                            <p class="textContenido">
                                <span style="font-family: 'Myriad Pro Bold';">Descripción:</span>&nbsp;
                                {{$fichaTecnica->FichaTecnica->Descripcion}}
                                <br>
                                <br>
                                ...
                                <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/EstatusConservacion/Extincion.png")}}" height="40"
                                    width="40" alt="">
                                @else
                                @if ($fichaTecnica->FichaTecnica->EstatusConv=='Amenaza')
                                <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/EstatusConservacion/Amenaza.png")}}" height="40"
                                    width="40" alt="">
                                @else
                                @if ($fichaTecnica->FichaTecnica->EstatusConv=='Vulnerable')
                                <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/EstatusConservacion/Vulnerable.png")}}" height="40"
                                    width="40" alt="">
                                @else
                                @if ($fichaTecnica->FichaTecnica->EstatusConv=='Menor preocupación')

                                <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/EstatusConservacion/MenorPreocupacion.png")}}"
                                    height="40" width="40" alt="">
                                @else
                                <img style="margin-top: 10px;" src="{{public_path("storage/Logos/FichasTecnicas/EstatusConservacion/SinProblema.png")}}" height="40"
                                    width="40" alt="">
                                @endif
                                @endif
                                @endif
                    ...
                    <div class="flex-container" style="height: 223px; margin: 0px 0px 40px 0px;">
                        <div class="itemC1">
                            <p class="titulos" style="margin-top: 0px;margin-bottom: 7.5pt; line-height: 7.5pt;">
                    ...
                    border: 1px  solid rgba(0, 0, 0, 0.3);">
                        ...
                        <div class="itemC1" style="margin-left:  484px">
                            <p class="titulos" style="margin-top: 0px;margin-bottom: 7.5pt; line-height: 7.5pt;"> CLIMA
                                EN HÁBITAT NATURAL</p>
                            <p class="parrafos" style="margin: 0%;text-align: justify;">
                    ...
                    <div>
                        <p class="titulos" style="margin-top: 0px;margin-bottom: 0px;color: black;text-align: left;">
                            RIESGOS Y AMENAZAS </p>
                        <hr style="color: black; width: 100%; margin:0%;margin-right: 91%;">
                        <p class="textContenido">
                            {{$fichaTecnica->FichaTecnica->AmenazasRiesgos}}

                        </p>
                        <p class="titulos" style="margin-top: 10px;margin-bottom: 0px;color: black;text-align: left;">
                    ...
                    <img style="margin-bottom: 10px;margin-top: 10px;" src="{{public_path("storage/Logos/Licencia.PNG")}}"alt="" height="30" width="100">
                ...
                <p class="textContenido">
                    ...
                    @else
                    <span>>Muestreo y
                        captura:</span>&nbsp;{{$fichaTecnica->FichaTecnica->NombreRecolectorMuestra}},&nbsp;{{$fichaTecnica->FichaTecnica->NombreRecolectorDatos}}
                    @endif
                    <br>
